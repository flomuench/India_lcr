...
***********************************************************************
* 	PART 1: variable selection: iteratively test-up		
***********************************************************************
...
* all (including high patent values)
		* (1-3) indian
...
* restrict sample to firms that won at least one auction
		* (1-3) indian
